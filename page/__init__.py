...
# 昵称
mp_nickname = (By.CSS_SELECTOR, ".user-name")        # 元组类型写不写小括号都是元组
...
# iframe
mp_iframe = By.CSS_SELECTOR, "#publishTinymce"
...
# 内容审核
mis__content_audit = By.CSS_SELECTOR, "//*[text='内容审核']/."
# 文章标题
