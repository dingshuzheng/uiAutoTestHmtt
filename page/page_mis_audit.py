...
class PageMisAudit(WebBase):
    ...
    def page_click_content_audit(self):
        ...
        sleep(1)
        # 2.点击内容审核
        self.base_click(page.mis__content_audit)
    ...
    # 9.点击确认
    def confipage_click_rm_pass(self):
        # 1.暂停时间
        sleep(1)
        # 2.点击确认
    ...
    def page_mis_audit(self, title, channel):
        log.info("正在调用审核文章业务操作方法，title：{} channel：{}".format(title, channel))
